...
PRIORITY_KEYS = ["vesselState", "portAcChargerPower", "stbdAcChargerPower","batteryStateOfChargePercent", "speedOverGround", "trip", "hvBatteryCapacity", "currentPositionLatitude", "currentPositionLongitude"]
