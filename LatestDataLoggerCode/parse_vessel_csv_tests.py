...
PRIORITY_KEYS = ["vesselState","batteryStateOfChargePercent", "speedOverGround", "stbdRpmShaft", "portRpmShaft", "motorPowerCombined", "portMotorPower", "stbdMotorPower", "currentPositionLatitude", "currentPositionLongitude"]
